...
CREATE TABLE `comments` (
  ...
  `desc` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=401 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
